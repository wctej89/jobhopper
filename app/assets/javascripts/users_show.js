  ...
  $('.wizard-search').on('keyup', _.debounce(function(e){
    ...
    if(e.keyCode == 8)
      ...
      else
      {
        ...
        {
          $('.tag_results').append(
            '<li><div class="tag-info"><div class="tag-name"><h3>' + response[i].name + '</h3></div><div class="tag-buttons"><button id='+ response[i].id +' class="add_to_queue" href="/user_tags/">Add</button></div></li>'
            );
        }
      });
    }
